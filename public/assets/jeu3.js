...
function Question(title, answers, answerCorrect) {
    this.title = title,
        ...
        this.getElement = function(indexQuestion, nbrOfQuestions) {
            ...
            document.getElementById("questions_screen").append(questionTitle);
            ...
            document.getElementById("questions_screen").append(questionNumber);

            document.getElementById("questions_screen").append(questionAnswer);
        }
    ...
    this.addAnswer = function(answer) {
        ...
        this.checkAnswer = (e) => {
            ...
            setTimeout(function() {
                document.getElementById("questions_screen").textContent = '';
...
function startQuestions() {
    document.getElementById("header_screen").style.display = "none";
    document.getElementById("questions_screen").style.display = "block";
