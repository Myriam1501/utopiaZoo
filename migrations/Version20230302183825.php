 ...
 */
final class Version20230302183825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, tickets_id_id INT DEFAULT NULL, date DATE NOT NULL, UNIQUE INDEX UNIQ_42C84955A76ED395 (user_id), INDEX IDX_42C8495587234BE8 (tickets_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
