 ...
 */
final class Version20230130095300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Account CHANGE Id id INT AUTO_INCREMENT NOT NULL, CHANGE name name VARCHAR(255) NOT NULL, CHANGE first_name first_name VARCHAR(255) NOT NULL, CHANGE Address address VARCHAR(255) DEFAULT NULL, CHANGE Passeword passeword INT NOT NULL, CHANGE Email_Login email_login VARCHAR(255) NOT NULL, CHANGE Date_Inscription date_inscription DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account CHANGE id Id INT AUTO_INCREMENT NOT NULL COMMENT \'Id\', CHANGE name name TEXT NOT NULL COMMENT \'Nom\', CHANGE first_name first_name TEXT NOT NULL COMMENT \'FirstName\', CHANGE address Address TEXT NOT NULL COMMENT \'Address\', CHANGE passeword Passeword INT NOT NULL COMMENT \'Passeword\', CHANGE email_login Email_Login TEXT NOT NULL COMMENT \'Email_Login\', CHANGE date_inscription Date_Inscription DATE NOT NULL COMMENT \'Date_Inscription\'');
    }
}
